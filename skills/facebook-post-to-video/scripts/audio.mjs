#!/usr/bin/env node
// audio.mjs — facebook-post-to-video audio ADAPTER. The TTS / BGM / SFX implementation
// no longer lives here: it is the shared engine at
// ../../media-use/audio/scripts/audio.mjs. This file only (a) maps the
// facebook-post-to-video model (SCRIPT.md frames + STORYBOARD.md music/sfx) into the
...
// STORYBOARD.md, which is facebook-post-to-video-specific).
//
...
// Engine neutral meta (id-keyed) → facebook-post-to-video meta (frame-keyed) consumed by
